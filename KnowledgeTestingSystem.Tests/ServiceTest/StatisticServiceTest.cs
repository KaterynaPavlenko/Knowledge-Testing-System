...
namespace KnowledgeTestingSystem.Tests.ServiceTest
{
    ...
    public class StatisticServiceTest
    {
        ...
        public void StatisticService_Can_Update_Statistic()
        {
            ...
            _unitOfWork.Setup(m => m.UserStatistic.GetById(statisticDto.Id))
                .Returns(statistics.FirstOrDefault(x => x.Id == statisticDto.Id));
        ...
        public void StatisticService_Can_Delete_Statistic()
        {
            ...
            _unitOfWork.Setup(m => m.UserStatistic.GetById(DeletedID))
                .Returns(statistics.FirstOrDefault(x => x.Id == DeletedID));
            // Act
