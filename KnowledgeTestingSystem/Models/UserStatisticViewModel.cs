...
namespace KnowledgeTestingSystem.Models
{
    public class UserStatisticViewModel
    {
        ...
        [Display(Name = "End Time")] public DateTime DateTimeEnd { get; set; }

        [Display(Name = "Percent correct answers")]
        public int PercentCorrectAnswer { get; set; }

        [Display(Name = "Test name")] public string Test { get; set; }

        [Display(Name = "User email")] public string User { get; set; }
