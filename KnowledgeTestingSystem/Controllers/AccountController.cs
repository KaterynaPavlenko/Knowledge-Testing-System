...
namespace KnowledgeTestingSystem.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(TestingSystemUserManager userManager, TestingSystemSignInManager signInManager)
        {
        ...
        public TestingSystemUserManager UserManager
        {
            get => _userManager ?? HttpContext.GetOwinContext().GetUserManager<TestingSystemUserManager>();
